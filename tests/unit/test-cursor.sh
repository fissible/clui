...
test_begin "cur_init: empty text — cursor at 0"
shellframe_cur_init "t"
assert_output "0" shellframe_cur_pos "t"

test_begin "cur_init: empty text — text is empty"
shellframe_cur_init "t"
assert_output "" shellframe_cur_text "t"

test_begin "cur_init: initial text — cursor at end"
shellframe_cur_init "t" "hello"
assert_output "5" shellframe_cur_pos "t"

test_begin "cur_init: initial text — text stored"
shellframe_cur_init "t" "hello"
assert_output "hello" shellframe_cur_text "t"

test_begin "cur_init: reinit resets state"
...
test_begin "cur_move: word_left skips trailing space then word"
...
test_begin "cur_move: word_left at 0 is no-op"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_move "t" word_left
assert_output "0" shellframe_cur_pos "t"

test_begin "cur_move: word_right skips to start of next word"
shellframe_cur_init "t" "hello world"
shellframe_cur_set "t" "hello world" 0  # before 'h'
shellframe_cur_move "t" word_right      # skip "hello" → 5, skip " " → 6
assert_output "6" shellframe_cur_pos "t"

test_begin "cur_move: word_right at end is no-op"
...
test_begin "cur_insert: insert at beginning"
...
test_begin "cur_insert: insert in middle"
...
test_begin "cur_insert: insert at end"
...
test_begin "cur_backspace: deletes char before cursor"
shellframe_cur_init "t" "abc"
...
test_begin "cur_backspace: at end deletes last char"
shellframe_cur_init "t" "abc"   # cursor at 3
shellframe_cur_backspace "t"
assert_output "ab" shellframe_cur_text "t"
assert_output "2"  shellframe_cur_pos  "t"

test_begin "cur_backspace: at pos 0 is no-op"
shellframe_cur_init "t" "abc"
shellframe_cur_set "t" "abc" 0
shellframe_cur_backspace "t"
assert_output "abc" shellframe_cur_text "t"
...
test_begin "cur_delete: deletes char at cursor"
shellframe_cur_init "t" "abc"
...
test_begin "cur_delete: at end is no-op"
shellframe_cur_init "t" "abc"   # cursor at 3
shellframe_cur_delete "t"
assert_output "abc" shellframe_cur_text "t"
assert_output "3"   shellframe_cur_pos  "t"

test_begin "cur_delete: at beginning deletes first char"
shellframe_cur_init "t" "abc"
shellframe_cur_set "t" "abc" 0
shellframe_cur_delete "t"
...
test_begin "cur_kill_to_end: from middle"
shellframe_cur_init "t" "hello world"
...
test_begin "cur_kill_to_end: from beginning"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_kill_to_end "t"
assert_output "" shellframe_cur_text "t"
...
test_begin "cur_kill_to_end: at end is no-op"
...
test_begin "cur_kill_to_start: from middle"
shellframe_cur_init "t" "hello world"
...
test_begin "cur_kill_to_start: from end"
shellframe_cur_init "t" "hello"   # cursor at 5
shellframe_cur_kill_to_start "t"
assert_output "" shellframe_cur_text "t"
assert_output "0" shellframe_cur_pos "t"

test_begin "cur_kill_to_start: at start is no-op"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_kill_to_start "t"
assert_output "hello" shellframe_cur_text "t"
...
test_begin "cur_kill_word_left: deletes last word"
shellframe_cur_init "t" "hello world"   # cursor at 11
shellframe_cur_kill_word_left "t"
assert_output "hello " shellframe_cur_text "t"
assert_output "6"      shellframe_cur_pos  "t"

test_begin "cur_kill_word_left: skips trailing space then word"
...
test_begin "cur_kill_word_left: at pos 0 is no-op"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_kill_word_left "t"
assert_output "hello" shellframe_cur_text "t"
...
test_begin "cur_kill_word_left: single word from end"
shellframe_cur_init "t" "hello"   # cursor at 5
shellframe_cur_kill_word_left "t"
assert_output "" shellframe_cur_text "t"
assert_output "0" shellframe_cur_pos "t"
...
test_begin "two contexts do not interfere"
