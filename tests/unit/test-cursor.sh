...
shellframe_test_begin "cur_init: empty text — cursor at 0"
shellframe_cur_init "t"
assert_output "0" shellframe_cur_pos "t"

shellframe_test_begin "cur_init: empty text — text is empty"
shellframe_cur_init "t"
assert_output "" shellframe_cur_text "t"

shellframe_test_begin "cur_init: initial text — cursor at end"
shellframe_cur_init "t" "hello"
assert_output "5" shellframe_cur_pos "t"

shellframe_test_begin "cur_init: initial text — text stored"
shellframe_cur_init "t" "hello"
assert_output "hello" shellframe_cur_text "t"

shellframe_test_begin "cur_init: reinit resets state"
...
shellframe_test_begin "cur_set: replaces text and moves cursor to end"
shellframe_cur_init "t"
shellframe_cur_set "t" "world"
assert_output "world" shellframe_cur_text "t"
assert_output "5"     shellframe_cur_pos  "t"

shellframe_test_begin "cur_set: explicit pos"
shellframe_cur_set "t" "hello" 2
assert_output "2" shellframe_cur_pos "t"

shellframe_test_begin "cur_set: pos clamped to 0"
shellframe_cur_set "t" "hello" -5
assert_output "0" shellframe_cur_pos "t"

shellframe_test_begin "cur_set: pos clamped to len"
shellframe_cur_set "t" "hello" 99
assert_output "5" shellframe_cur_pos "t"

# ── shellframe_cur_move ────────────────────────────────────────────────────────

shellframe_test_begin "cur_move: right increments pos"
shellframe_cur_init "t" "abc"
shellframe_cur_set "t" "abc" 0
shellframe_cur_move "t" right
assert_output "1" shellframe_cur_pos "t"

shellframe_test_begin "cur_move: right clamps at end"
shellframe_cur_init "t" "abc"
shellframe_cur_move "t" right   # pos was 3 (end)
assert_output "3" shellframe_cur_pos "t"

shellframe_test_begin "cur_move: left decrements pos"
shellframe_cur_init "t" "abc"
shellframe_cur_move "t" left
assert_output "2" shellframe_cur_pos "t"

shellframe_test_begin "cur_move: left clamps at 0"
shellframe_cur_init "t"
shellframe_cur_move "t" left
assert_output "0" shellframe_cur_pos "t"

shellframe_test_begin "cur_move: home sets pos to 0"
shellframe_cur_init "t" "hello"
shellframe_cur_move "t" home
assert_output "0" shellframe_cur_pos "t"

shellframe_test_begin "cur_move: end sets pos to len"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_move "t" end
assert_output "5" shellframe_cur_pos "t"

shellframe_test_begin "cur_move: word_left skips to start of word"
...
shellframe_test_begin "cur_move: word_left skips trailing space then word"
...
shellframe_test_begin "cur_move: word_left at 0 is no-op"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_move "t" word_left
assert_output "0" shellframe_cur_pos "t"

shellframe_test_begin "cur_move: word_right skips to start of next word"
shellframe_cur_init "t" "hello world"
shellframe_cur_set "t" "hello world" 0  # before 'h'
shellframe_cur_move "t" word_right      # skip "hello" → 5, skip " " → 6
assert_output "6" shellframe_cur_pos "t"

shellframe_test_begin "cur_move: word_right at end is no-op"
...
shellframe_test_begin "cur_insert: insert at beginning"
...
shellframe_test_begin "cur_insert: insert in middle"
...
shellframe_test_begin "cur_insert: insert at end"
...
shellframe_test_begin "cur_backspace: deletes char before cursor"
shellframe_cur_init "t" "abc"
...
shellframe_test_begin "cur_backspace: at end deletes last char"
shellframe_cur_init "t" "abc"   # cursor at 3
shellframe_cur_backspace "t"
assert_output "ab" shellframe_cur_text "t"
assert_output "2"  shellframe_cur_pos  "t"

shellframe_test_begin "cur_backspace: at pos 0 is no-op"
shellframe_cur_init "t" "abc"
shellframe_cur_set "t" "abc" 0
shellframe_cur_backspace "t"
assert_output "abc" shellframe_cur_text "t"
...
shellframe_test_begin "cur_delete: deletes char at cursor"
shellframe_cur_init "t" "abc"
...
shellframe_test_begin "cur_delete: at end is no-op"
shellframe_cur_init "t" "abc"   # cursor at 3
shellframe_cur_delete "t"
assert_output "abc" shellframe_cur_text "t"
assert_output "3"   shellframe_cur_pos  "t"

shellframe_test_begin "cur_delete: at beginning deletes first char"
shellframe_cur_init "t" "abc"
shellframe_cur_set "t" "abc" 0
shellframe_cur_delete "t"
...
shellframe_test_begin "cur_kill_to_end: from middle"
shellframe_cur_init "t" "hello world"
...
shellframe_test_begin "cur_kill_to_end: from beginning"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_kill_to_end "t"
assert_output "" shellframe_cur_text "t"
...
shellframe_test_begin "cur_kill_to_end: at end is no-op"
...
shellframe_test_begin "cur_kill_to_start: from middle"
shellframe_cur_init "t" "hello world"
...
shellframe_test_begin "cur_kill_to_start: from end"
shellframe_cur_init "t" "hello"   # cursor at 5
shellframe_cur_kill_to_start "t"
assert_output "" shellframe_cur_text "t"
assert_output "0" shellframe_cur_pos "t"

shellframe_test_begin "cur_kill_to_start: at start is no-op"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_kill_to_start "t"
assert_output "hello" shellframe_cur_text "t"
...
shellframe_test_begin "cur_kill_word_left: deletes last word"
shellframe_cur_init "t" "hello world"   # cursor at 11
shellframe_cur_kill_word_left "t"
assert_output "hello " shellframe_cur_text "t"
assert_output "6"      shellframe_cur_pos  "t"

shellframe_test_begin "cur_kill_word_left: skips trailing space then word"
...
shellframe_test_begin "cur_kill_word_left: at pos 0 is no-op"
shellframe_cur_init "t" "hello"
shellframe_cur_set "t" "hello" 0
shellframe_cur_kill_word_left "t"
assert_output "hello" shellframe_cur_text "t"
...
shellframe_test_begin "cur_kill_word_left: single word from end"
shellframe_cur_init "t" "hello"   # cursor at 5
shellframe_cur_kill_word_left "t"
assert_output "" shellframe_cur_text "t"
assert_output "0" shellframe_cur_pos "t"
...
shellframe_test_begin "two contexts do not interfere"
