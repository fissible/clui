...
shellframe_test_begin "field_on_key: backspace removes last char, returns 0"
_reset_field
...
shellframe_test_begin "field_on_key: backspace at pos 0 does nothing"
_reset_field
...
shellframe_test_begin "field_on_key: left arrow moves cursor, returns 0"
_reset_field
...
shellframe_test_begin "field_on_key: right arrow moves cursor, returns 0"
_reset_field
...
shellframe_test_begin "field_on_key: Ctrl-K kills to end"
_reset_field
shellframe_cur_set "f" "hello" 2   # text="hello", cursor=2
...
shellframe_test_begin "field_on_key: Ctrl-U kills to start"
_reset_field
shellframe_cur_set "f" "hello" 3   # text="hello", cursor=3
...
shellframe_test_begin "field_on_key: Ctrl-W kills word left"
_reset_field
...
shellframe_test_begin "field_on_key: Enter (\\r) returns 2"
_reset_field
shellframe_field_on_key $'\r'
assert_eq "2" "$?" "Enter returns 2"

shellframe_test_begin "field_on_key: Enter (\\n) returns 2"
_reset_field
shellframe_field_on_key $'\n'
...
shellframe_test_begin "field_on_key: Page Up returns 1 (not handled)"
_reset_field
shellframe_field_on_key $'\033[5~'
assert_eq "1" "$?" "Page Up returns 1"

shellframe_test_begin "field_on_key: Escape returns 1"
_reset_field
shellframe_field_on_key $'\033'
assert_eq "1" "$?" "Escape returns 1"

shellframe_test_begin "field_on_key: F1 returns 1"
_reset_field
...
shellframe_test_begin "field_size: returns 1 1 0 1"
