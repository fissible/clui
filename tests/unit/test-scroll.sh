...
shellframe_test_begin "scroll_init: top starts at 0"
shellframe_scroll_init "t" 100 80 20 40
assert_output "0" shellframe_scroll_top "t"

shellframe_test_begin "scroll_init: left starts at 0"
assert_output "0" shellframe_scroll_left "t"

shellframe_test_begin "scroll_init: reinit resets offsets"
shellframe_scroll_init "t" 100 80 20 40
...
shellframe_test_begin "ensure_col: col already visible — no change"
shellframe_scroll_init "t" 100 80 20 20
shellframe_scroll_move "t" right 10
shellframe_scroll_ensure_col "t" 15   # 15 in viewport [10, 29]
assert_output "10" shellframe_scroll_left "t"

shellframe_test_begin "ensure_col: col to the left — scroll left"
shellframe_scroll_init "t" 100 80 20 20
shellframe_scroll_move "t" right 20
shellframe_scroll_ensure_col "t" 5
assert_output "5" shellframe_scroll_left "t"

shellframe_test_begin "ensure_col: col to the right — scroll right"
shellframe_scroll_init "t" 100 80 20 20
...
shellframe_test_begin "row_visible: first row of viewport — visible"
shellframe_scroll_init "t" 100 80 20 40
shellframe_scroll_move "t" down 10
shellframe_scroll_row_visible "t" 10
assert_eq "0" "$?" "first row visible"

shellframe_test_begin "row_visible: last row of viewport — visible"
shellframe_scroll_init "t" 100 80 20 40
shellframe_scroll_move "t" down 10
shellframe_scroll_row_visible "t" 29
assert_eq "0" "$?" "last row visible"

shellframe_test_begin "row_visible: row above viewport — not visible"
shellframe_scroll_init "t" 100 80 20 40
shellframe_scroll_move "t" down 10
shellframe_scroll_row_visible "t" 9
assert_eq "1" "$?" "row above not visible"

shellframe_test_begin "row_visible: row below viewport — not visible"
shellframe_scroll_init "t" 100 80 20 40
shellframe_scroll_move "t" down 10
...
shellframe_test_begin "two contexts are independent"
...
shellframe_test_begin "scroll_resize: recamps offset when viewport grows"
...
shellframe_test_begin "out_var form: top via variable"
shellframe_scroll_init "t" 100 80 20 40
