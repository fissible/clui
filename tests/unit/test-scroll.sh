...
test_begin "scroll_init: top starts at 0"
shellframe_scroll_init "t" 100 80 20 40
assert_output "0" shellframe_scroll_top "t"

test_begin "scroll_init: left starts at 0"
assert_output "0" shellframe_scroll_left "t"

test_begin "scroll_init: reinit resets offsets"
shellframe_scroll_init "t" 100 80 20 40
...
test_begin "row_visible: first row of viewport — visible"
shellframe_scroll_init "t" 100 80 20 40
shellframe_scroll_move "t" down 10
shellframe_scroll_row_visible "t" 10
assert_eq "0" "$?" "first row visible"

test_begin "row_visible: last row of viewport — visible"
shellframe_scroll_init "t" 100 80 20 40
shellframe_scroll_move "t" down 10
shellframe_scroll_row_visible "t" 29
assert_eq "0" "$?" "last row visible"

test_begin "row_visible: row above viewport — not visible"
shellframe_scroll_init "t" 100 80 20 40
shellframe_scroll_move "t" down 10
shellframe_scroll_row_visible "t" 9
assert_eq "1" "$?" "row above not visible"

test_begin "row_visible: row below viewport — not visible"
shellframe_scroll_init "t" 100 80 20 40
shellframe_scroll_move "t" down 10
...
test_begin "two contexts are independent"
...
test_begin "scroll_resize: recamps offset when viewport grows"
...
test_begin "out_var form: top via variable"
shellframe_scroll_init "t" 100 80 20 40
