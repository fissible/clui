...
test_begin "shellframe_pad_left: basic left-align with padding"
result="$(shellframe_pad_left "hello" "hello" 10)"
assert_eq "hello     " "$result"

test_begin "shellframe_pad_left: exact width — no padding"
result="$(shellframe_pad_left "hello" "hello" 5)"
assert_eq "hello" "$result"

test_begin "shellframe_pad_left: wider than width — no truncation"
result="$(shellframe_pad_left "toolong" "toolong" 4)"
assert_eq "toolong" "$result"

test_begin "shellframe_pad_left: zero width string"
result="$(shellframe_pad_left "" "" 5)"
assert_eq "     " "$result"

test_begin "shellframe_pad_left: ANSI rendered; raw used for width"
...
test_begin "shellframe_pad_left: width equals raw length with ANSI in rendered"
raw="hi"
