...
shellframe_test_begin "keyname: unknown multi-byte sequence returns empty"
assert_output "" shellframe_keyname $'\x1b[999~'

# ── shellframe_keymap_bind + shellframe_keymap_lookup ─────────────────────────

shellframe_test_begin "keymap_bind/lookup: roundtrip"
...
shellframe_test_begin "keymap_lookup: unbound key returns empty"
assert_output "" shellframe_keymap_lookup "tmap" "$SHELLFRAME_KEY_DOWN"

shellframe_test_begin "keymap_bind: overwrite existing binding"
...
shellframe_test_begin "keymap_lookup: out_var form"
_km_action=""
...
shellframe_test_begin "keymap: two keymaps do not interfere"
