...
shellframe_test_begin "list_init: cursor starts at 0"
_reset_list
assert_output "0" shellframe_sel_cursor "lst"

shellframe_test_begin "list_init: scroll top starts at 0"
_reset_list
assert_output "0" shellframe_scroll_top "lst"

shellframe_test_begin "list_init: reinit resets cursor to 0"
_reset_list
...
shellframe_test_begin "list_on_key: down moves cursor, returns 0"
_reset_list
shellframe_list_on_key $'\033[B'
assert_eq "0" "$?" "down returns 0"
assert_output "1" shellframe_sel_cursor "lst"

shellframe_test_begin "list_on_key: up moves cursor, returns 0"
_reset_list
...
shellframe_test_begin "list_on_key: up at top clamps at 0"
_reset_list
shellframe_list_on_key $'\033[A'
assert_output "0" shellframe_sel_cursor "lst"

shellframe_test_begin "list_on_key: down at bottom clamps at last item"
_reset_list
shellframe_list_on_key $'\033[B'
shellframe_list_on_key $'\033[B'
shellframe_list_on_key $'\033[B'
...
shellframe_test_begin "list_on_key: home moves cursor to 0"
_reset_list
shellframe_list_on_key $'\033[B'   # cursor → 1
shellframe_list_on_key $'\033[B'   # cursor → 2
...
shellframe_test_begin "list_on_key: end moves cursor to last"
_reset_list
...
shellframe_test_begin "list_on_key: page_down moves by viewport rows"
...
shellframe_test_begin "list_on_key: page_up moves by viewport rows"
...
shellframe_test_begin "list_on_key: Enter (\\r) returns 2"
_reset_list
shellframe_list_on_key $'\r'
assert_eq "2" "$?" "Enter returns 2"

shellframe_test_begin "list_on_key: Enter (\\n) returns 2"
_reset_list
...
shellframe_test_begin "list_on_key: space toggles when multiselect=1"
_reset_list
...
shellframe_test_begin "list_on_key: space untoggles when multiselect=1"
# state from previous test: item 0 is selected, multiselect=1
shellframe_list_on_key " "
assert_output "0" shellframe_sel_selected_count "lst"

shellframe_test_begin "list_on_key: space not handled when multiselect=0"
_reset_list
SHELLFRAME_LIST_MULTISELECT=0
shellframe_list_on_key " "
...
shellframe_test_begin "list_on_key: unhandled key returns 1"
_reset_list
shellframe_list_on_key "x"
assert_eq "1" "$?" "unhandled key returns 1"

shellframe_test_begin "list_on_key: Escape returns 1"
_reset_list
...
shellframe_test_begin "list_size: returns 1 1 0 0"
